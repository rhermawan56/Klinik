...
public class ModalPoliAnak {
    ...
    public ModalPoliAnak(Integer _id, Integer _idbooking, String _namars, String _namadok, String _polidok, String _namaakun){
        this._id = _id;
    ...
    public static Integer get_idbooking(){
        return _idbooking;
    }
