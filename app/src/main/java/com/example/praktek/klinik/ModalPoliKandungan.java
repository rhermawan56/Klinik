...
public class ModalPoliKandungan {
    public static Integer _id, _idbooking;
    public static String _namars, _namadok, _polidok, _namaakun;

    //constructor
    public ModalPoliKandungan(){}
    public ModalPoliKandungan(Integer _id, Integer _idbooking, String _namars, String _namadok, String _polidok, String _namaakun){
        this._id = _id;
